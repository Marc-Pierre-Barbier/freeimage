...
*/
static bool
freeimg_jpeg_read_icc_profile(j_decompress_ptr cinfo, JOCTET **icc_data_ptr, unsigned *icc_data_len) {
...
read_markers(j_decompress_ptr cinfo, FIBITMAP *dib) {
	...
	if(freeimg_jpeg_read_icc_profile(cinfo, &icc_profile, &icc_length) ) {
